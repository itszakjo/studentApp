...
public class ZakjoVideoPlayer extends AppCompatActivity implements InternetConnectivityListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zakjovideo_player);

        InternetAvailabilityChecker.init(this);

        intent  = getIntent();

        vLINK  = intent.getStringExtra("VIDEOLINK");
